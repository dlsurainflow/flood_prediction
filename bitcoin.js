...
function onClickFetchData() {
  ...
  let requestUrl =
    "https://production.api.coindesk.com/v2/price/values/BTC?start_date=2010-07-17T16:00&end_date=2020-11-24T17:18&ohlc=false";
  ...
  $.getJSON(requestUrl, function (data) {
    ...
    if (daily) {
      ...
      if (data_raw.length > 0) {
        ...
        Plotly.newPlot(
          graph_plot,
          [{ x: timestamps, y: prices, name: "Bitcoin Price Index" }],
          { margin: { t: 0 } }
        );
      }
