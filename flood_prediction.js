...
function onClickFetchData() {
  ...
  const data = [
    ...
    {
      time: "2020-11-12 01:00:00",
      value: 0,
    },
    {
      time: "2020-11-12 02:00:00",
      value: 0,
    },
    {
      time: "2020-11-12 03:00:00",
      value: 0,
    },
    {
      time: "2020-11-12 04:00:00",
      value: 0,
    },
    {
      time: "2020-11-12 05:00:00",
      value: 0,
    },
    {
      time: "2020-11-12 06:00:00",
      value: 0,
    },
    {
      time: "2020-11-12 07:00:00",
      value: 10,
    },
    {
      time: "2020-11-12 08:39:00",
      value: 25,
    },
    {
      time: "2020-11-12 09:00:00",
      value: 33,
    },
    {
      time: "2020-11-12 10:00:00",
      value: 56,
    },
    {
      time: "2020-11-12 11:00:00",
      value: 79,
    },
    {
      time: "2020-11-12 12:44:00",
      value: 119,
    },
    {
      time: "2020-11-12 13:00:00",
      value: 117,
    },
    {
      time: "2020-11-12 14:08:00",
      value: 109,
    },
    {
      time: "2020-11-12 15:39:00",
      value: 90,
    },
    {
      time: "2020-11-12 16:00:00",
      value: 87,
    },
    {
      time: "2020-11-12 17:37:00",
      value: 71,
    },
    {
      time: "2020-11-12 18:00:00",
      value: 66,
    },
    {
      time: "2020-11-12 19:22:00",
      value: 49,
    },
    {
      time: "2020-11-12 20:00:00",
      value: 40,
    },
    {
      time: "2020-11-12 21:00:00",
      value: 25,
    },
    {
      time: "2020-11-12 22:38:00",
      value: 1,
    },
    {
      time: "2020-11-12 23:00:00",
      value: 0,
    },
    {
    ...
    {
      time: "2020-11-13 01:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 02:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 03:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 04:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 05:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 06:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 07:00:00",
      value: 0,
    },
    {
    ...
    {
      time: "2020-11-13 09:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 10:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 11:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 12:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 13:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 14:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 15:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 16:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 17:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 18:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 19:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 20:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 21:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 22:00:00",
      value: 0,
    },
    {
      time: "2020-11-13 23:00:00",
      value: 0,
    },
    {
    ...
    {
      time: "2020-11-14 01:00:00",
      value: 0,
    },
    {
      time: "2020-11-14 02:00:00",
      value: 4,
    },
    {
      time: "2020-11-14 03:00:00",
      value: 10,
    },
    {
      time: "2020-11-14 04:00:00",
      value: 17,
    },
  ];
  ...
  // let requestUrl =
  //   "https://production.api.coindesk.com/v2/price/values/BTC?start_date=2010-07-17T16:00&end_date=2020-11-18T10:18&ohlc=false";
  ...
  // $.getJSON("./raft_ralph.json", function (data) {
  ...
  //   var timestamp = new Date(daily[date][0]).toDateString();
  //   data_raw.push({
  //     timestamp: timestamp,
  //     price: parseFloat(daily[date][1]),
  //   });
  //   index++;
  // }
  ...
  if (data.length > 0) {
    ...
    let value = data.map(function (val) {
      return val["value"];
    });
    ...
    Plotly.newPlot(
      graph_plot,
      [{ x: timestamps, y: value, name: "Flood Depth" }],
      { margin: { t: 0 } }
    );
  }
...
function onClickDisplaySMA() {
 ...
 // window_size = parseInt(document.getElementById("input_windowsize").value);
  ...
  let value = data_raw.map(function (val) {
  ...
  Plotly.newPlot(
    graph_plot,
    [{ x: timestamps_a, y: value, name: "Stock Price" }],
    { margin: { t: 0 } }
  );
...
function displayTrainingData() {
  ...
  for (let index = 0; index < 25; index++) {
    data_output +=
      ...
      set[index]
        .map(function (val) {
          return (Math.round(val["value"] * 10000) / 10000).toString();
        })
        .toString() +
      "]</td><td>" +
      sma_vec[index]["avg"] +
...
async function onClickPredict() {
  ...
  last_date.setHours(last_date.getHours() + add_hours);
  console.log(last_date);
  ...
  Plotly.newPlot(
    graph_plot,
    [{ x: timestamps_d, y: pred_X[0], name: "Current Flood Depth" }],
    { margin: { t: 0 } }
  );
  Plotly.plot(
    graph_plot,
    [{ x: timestamps_e, y: pred_y, name: "Predicted Flood Depth" }],
    { margin: { t: 0 } }
  );
...
function demo() {
  ...
  $("#div_linegraph_data_title").text(
    "Symbol: MSFT (last refreshed 2019-03-08)"
  );
  ...
  $("#div_container_sma").show();
  $("#div_linegraph_sma_title").text(
    "Stock Price and Simple Moving Average (window: 50)"
  );
  $("#div_container_trainingdata").show();
  ...
  Plotly.plot(graph_plot2, [{ x: timestamps_b, y: sma, name: "SMA" }], {
    margin: { t: 0 },
  });
  ...
  let loss = [
    ...
    0.15503166615962982,
    0.07642599940299988,
    0.044394541531801224,
    0.08119461685419083,
    0.04174267500638962,
    0.013500338420271873,
    0.009518957696855068,
    0.011541156098246574,
    0.020290391519665718,
    0.012824371457099915,
    0.007728812284767628,
    0.0032212012447416782,
    0.002496731234714389,
    0.002818638924509287,
    0.003657675813883543,
    0.0040054721757769585,
    0.007610109634697437,
    0.006869967561215162,
    0.008261540904641151,
    0.007415720261633396,
    0.004650598857551813,
    0.006486714817583561,
    0.005553357768803835,
    0.005444769747555256,
    0.0030655807349830866,
    0.0013217271771281958,
    0.0014652956742793322,
    0.002561884233728051,
    0.0026924889534711838,
  ...
  Plotly.newPlot(
    ...
    [
      {
        x: Array.from({ length: loss.length }, (v, k) => k + 1),
        y: loss,
        name: "Loss",
      },
    ],
  ...
  Plotly.plot(
    graph_plot4,
    [{ x: timestamps_c, y: pred_vals, name: "Predicted" }],
    { margin: { t: 0 } }
  );
}
